...
def callContractFunction(func_name,call_args=None,tx_value=0):
    ...
    ContractXX.__getattr__(func_name)(args=call_args,value=tx_value)
...
#constrainTo("nextIsBlockNumber",True)
#constrainTo("isBlockNumber",False)

#blockNumber1 = callContractFunction("blockNumber")
balance1 = callContractFunction("balance")

callContractFunction("count",tx_value="symbolic")
m.end_block()

balance2 = callContractFunction("balance")
#blockNumber2 = callContractFunction("blockNumber")

m.constrain(balance2==balance1)
state_is_reachable(m)
m.constrain(operators.NOT(balance2==balance1))
state_is_reachable(m)


#constrainTo("blockNumber",blockNumber1)
#constrainTo("blockNumber",blockNumber2)

#constrainTo("nextIsBlockNumber",False)
#constrainTo("isBlockNumber",True)
